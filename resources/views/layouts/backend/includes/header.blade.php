    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            <div class="navbar-header">
                <!-- Navbar Header--><a href="{{route('app.dashboard')}}" class="navbar-brand">
                    <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Lara</strong><strong>statur</strong></div>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                            ...
                            onclick="event.preventDefault();
                                        this.closest('form').submit();" id="logout"class="nav-link"> Logout <i class="icon-logout"></i></a>
                    </form>
                </div>
            </div>
        </div>
